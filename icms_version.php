...
$modversion = array('name'			=> _MI_CCENTER_NAME,
					...
					'credits'		=> "Nobuhiro Yasutomi, QM-B",
					'author'		=> "fiammybe",
					'credits'		=> "Nobuhiro Yasutomi, QM-B, fiammybe",
					'author'		=> "fiammybe",
					'help'			=> "help.html",
					...
					'image'			=> "ccenter_icon_big.png", /* for backward compatibility */
					...
					'status'=> "alpha",
					'date'=> "18 Aug 2025",
					'author_word'=> "Prepare for icms 2.0",
  );
