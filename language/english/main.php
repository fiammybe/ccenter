...
define('_MD_SUBMIT_VIEW','Aktualisieren');
...
define('_MD_USER_EVAL','Bewertung nach Kunde');
define('_MD_POSTDATE','Geschrieben am');
define('_MD_MODDATE','Aktualisiert');
define('_MD_ATTACHMENT','Anlage');
define('_MD_MSG_READTHIS','Gelesen');
define('_MD_MSG_NOTREAD','Nicht gelesen');
define('_MD_EVAL_THANKYOU','Vielen Dank für die Bewertung.');
define('_MD_EVAL_VALUE','Diese Rückmeldung bewerten');
define('_MD_EVAL_DESC','Sind Sie mit dem Antwortschreiben zufrieden gewesen? Sewnden Sie uns bitte Ihre Einschätzung als Kommentar.');
define('_MD_EVAL_COMMENT','Bewertung kommentieren');
define('_MD_EVAL_SUBMIT','Bewertung absenden');
define('_MD_EVAL_DATE','Bewertet');
...
define('_MD_NODATA','KEINE Nachrichten');

define('_MD_EVAL_VAL_LOW','Niedrig');
define('_MD_EVAL_VAL_MID','Normal');
define('_MD_EVAL_VAL_MAX','Sehr gut');
...
define('_CO_CCENTER_FORMS_CATS', 'Kategorien');
define('_CO_CCENTER_NO_CATS_TO_DISPLAY', 'Keine Kategorien vorhanden');
